...
-- НЕ УДАЛЯТЬ! Используется в Wildwest и Gunfreezone
...
MODE.Type = MODE.Type or "soe" -- Изменил дефолт со standard на soe, чтобы не крашило
...
function MODE:EquipSWAT(ply, index)
    ...
    local classes = {
        [1] = function() return tbl_Random({"weapon_m4a1", "weapon_hk416"}) end,
        [2] = function() ply:Give("weapon_ram") return tbl_Random({"weapon_remington870", "weapon_m590a1"}) end,
