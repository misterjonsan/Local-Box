--\\
hg.VGUI = hg.VGUI or {}
hg.VGUI.MainColor = Color(200,0,0)
hg.VGUI.SecondaryColor = Color(200,0,0,240)
hg.VGUI.BackgroundColor = Color(18,18,20,235)
...
SKIN.Colours.Outline = (hg.theme and hg.theme.c.outline) or Color(80,60,40,160)
...
function SKIN:PaintPropertySheet( panel, width, height )
    ...
    local acc = (hg.theme and hg.theme.c.accent) or hg.VGUI.MainColor
    surface.SetDrawColor(acc.r, acc.g, acc.b, 150)
	surface.DrawOutlinedRect(0, 0, width, height)
end
...
function SKIN:PaintActiveTab( panel, w, h )
    ...
    local acc2 = (hg.theme and hg.theme.c.accent) or hg.VGUI.MainColor
    surface.SetDrawColor(acc2.r, acc2.g, acc2.b, 150)
