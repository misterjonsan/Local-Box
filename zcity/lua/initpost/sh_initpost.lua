-- "addons\\homigrad\\lua\\initpost\\sh_initpost.lua"
	...
	hook.Add("OnEntityCreated", "huyasdowo", function(ent)
		if SDOIsDoor(ent) then
			if CLIENT then
				...
				local speed = input.LookupBinding("+speed") or "shift"
				...
				"<font=ZCity_Tiny>"..string.upper( use ).." + ".. string.upper( speed ) .." open faster</font>\n"
