...
SWEP.Instructions = "FN SCAR (English. Special Operations Forces Combat Assault Rifle[11] — a combat assault rifle for special operations forces) is a weapon system developed by the American division of the Belgian company FN Herstal to participate in the competition for a new assault rifle for USSOCOM soldiers in 2004. This gun chambered in 5.56x45 caliber"
SWEP.Category = "Weapons - Assault Rifles"
SWEP.Slot = 2
SWEP.SlotPos = 10
SWEP.ViewModel = ""
SWEP.WorldModel = "models/weapons/tfa_ins2/akpack/w_ak74.mdl"
SWEP.WorldModelFake = "models/weapons/arccw/c_mw3e_scarl.mdl" -- МОДЕЛЬ ГОВНА, НАЙТИ НОРМАЛЬНЫЙ КАЛАШ
