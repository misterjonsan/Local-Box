...
spawnmenu.AddContentType("zbase_npcs", function( container, obj )
    ...
    icon:SetColor( (hg.theme and hg.theme.c.accent) or Color(200,110,0) )
...
function PANEL:AddDropdown( text, func, startVal )
	...
	label:SetText(text)
	label:Dock(TOP)
    label:SetColor((hg.theme and hg.theme.c.text) or Color(215,215,215))
...
function PANEL:AddHelp( text )
	...
	label:SetText(text)
	label:Dock(TOP)
    label:SetColor(Color(140,140,140))
end
